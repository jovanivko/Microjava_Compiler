...
public class VarNameListDerived1 extends VarNameList {

    private VarNameList VarNameList;
    private VarName VarName;

    public VarNameListDerived1 (VarNameList VarNameList, VarName VarName) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarNameListDerived1(\n");
