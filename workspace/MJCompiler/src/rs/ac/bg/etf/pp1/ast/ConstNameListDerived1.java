...
public class ConstNameListDerived1 extends ConstNameList {

    private ConstNameList ConstNameList;
    private ConstName ConstName;

    public ConstNameListDerived1 (ConstNameList ConstNameList, ConstName ConstName) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstNameListDerived1(\n");
