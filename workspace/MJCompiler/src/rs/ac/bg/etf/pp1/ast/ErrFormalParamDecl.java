...
public class ErrFormalParamDecl extends FormalParamList {

    private FormalParamList FormalParamList;
    private FormalParamDecl FormalParamDecl;

    public ErrFormalParamDecl (FormalParamList FormalParamList, FormalParamDecl FormalParamDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ErrFormalParamDecl(\n");
